...
<form method="POST"
	action="index.php?action=sign&subaction=signedit&sign_id=<?php echo $sign_id;?>">
	<table width="800">
		<tr>
		...
		<tr>
			...
			<th><input name="sign_actif" value="1"
			<?php if($sign['sign_actif']==1) { echo " checked " ;} ?>
				type="checkbox"></th>
		</tr>

		<tr>
			<th>Utilisateur cible</th>
			<th><select name="cible">
					<?php foreach ($user as $key => $value ):?>
					<option <?php if ($sign['cible_id'] == $key):?> selected
		...
		<tr>
			<th>Script</th>
			<th><textarea rows="10" cols="200" name="code">
					<?php echo $sign['code']?>
				</textarea>
			</th>
		</tr>
